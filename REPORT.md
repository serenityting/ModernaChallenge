...
- **Quantum-inspired methods**: classical algorithms (simulated annealing, simulated bifurcation, tensor-network contraction) that mimic annealing-like dynamics without quantum hardware. As shown below, these are currently  *practical* backend for this problem size.
